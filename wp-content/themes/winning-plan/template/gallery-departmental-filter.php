<?php
/*
Template Name: GL exercise filter
*/
get_header('personal');
...
?>
    ...
    <div class="container">
        ...
        <form action="" id="gallery-filter">
            ...
            <input type="hidden" name="post_type" value="drill">
            <div class="gallery-filter">
                <div class="gallery-filter__form">
                    <div class="gallery-filter__item">
                        ...
                        <?php
                        $args = array(
                            'taxonomy' => array('drills_сategory','manager_drills_сategory'),
                            'hide_empty' => false,
                            'fields' => 'all',
                            'count' => true,
                            'parent' => 0
                        ...
                        if ($term_query) {
                            ?>
                            <select name="drills_сategory">
                                <option value="all">
                                    <?php _e('All','winning_plan')?>
                                </option>
                                <?php foreach ($term_query as $term) {
                                    $selected = '';
                                    if ($_GET['drills_сategory'] == $term->term_id) {
                                        $selected = 'selected';
                                    }
                                    ?>
                                    <option data-taxonomy="<?php echo $term->taxonomy; ?>" <?php echo $selected; ?> value="<?php echo $term->term_id; ?>">
                                        <?php echo $term->name; ?>
                                    </option>
                                <?php } ?>
                            </select>
            ...
            <div class="gallery-сategory">
                ...
                <span>
                    ...
                    <?php _e('תרגילי טכניקה', 'winning_plan'); ?>
                </span>
                </div>
                ...
                echo '<input type="hidden" name="recommended" value="true">';
...
*/
                ...
                if ($query->have_posts()) {
                    ?>
                    <div id="drills-result-filter" class="gallery-drills__list">
