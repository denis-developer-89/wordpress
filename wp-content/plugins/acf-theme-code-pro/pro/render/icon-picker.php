...
echo $this->indent . htmlspecialchars("	<img src=\"<?php echo get_stylesheet_directory_uri(); ?>/assets/images/acf/<?php " . $this->the_field_method . "( '" . $this->name ."'". $this->location_rendered_param . " ); ?>.svg\" />\n");
